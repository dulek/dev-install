...
class DSALHelper(object):
    ...
    def _get_arg_parser(self):
        ...
        openshift_install_cfg.add_argument('--ssh-key', required=True,
    ...
    def anaconda_cfg(self, args):
        # TODO(dulek): Choosing template based on requested OS.
        self._render('anaconda', 'anaconda-ks-8.4.cfg.tpl',
